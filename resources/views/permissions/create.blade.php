                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <input class="form-control" required="" placeholder="Permission name" type="text" name="name" value="{{ old('name') }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    <input class="form-control" required="" placeholder="Display Name" type="text" name="display_name" value="{{ old('display_name') }}">
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" type="text" cols="300" name="description" placeholder="Desciption">{{ old('description') }}</textarea>                               
                                </div>                                
                            </div>
                        </div>
                    </div>
